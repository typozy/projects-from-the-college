...
void HashSetVec(){
	cout << "\n//HashSet with vector<int>\n\n";
	HashSet<int,vector<int> > con1;
	Collection<int,vector<int> > * colptr1 = &con1;
	Iterator<int,vector<int> > it;
	for (int i = 0; i < 100; ++i){
		colptr1->add(i);
	}
	HashSet<int,vector<int> > con2;
...
void HashSetVecStr(){
	cout << "\n//HashSet with vector<string>\n\n";
	HashSet<string,vector<string> > con1;
	...
	colptr1->add("I");
	colptr1->add("J");
	HashSet<string,vector<string> > con2;
...
void HashSetList(){
	cout << "\n//HashSet with list<int>\n\n";
	HashSet<int,list<int> > con1;
	Collection<int,list<int> > * colptr1 = &con1;
	Iterator<int,list<int> > it;
	for (int i = 0; i < 100; ++i){
		colptr1->add(i);
	}
	HashSet<int,list<int> > con2;
...
void HashSetListStr(){
	cout << "\n//HashSet with list<string>\n\n";
	HashSet<string,list<string> > con1;
	...
	colptr1->add("I");
	colptr1->add("J");
	HashSet<string,list<string> > con2;
...
void HashSetSet(){
	cout << "\n//HashSet with set<int>\n\n";
	HashSet<int,set<int> > con1;
	Collection<int,set<int> > * colptr1 = &con1;
	Iterator<int,set<int> > it;
	for (int i = 0; i < 100; ++i){
		colptr1->add(i);
	}
	HashSet<int,set<int> > con2;
...
void HashSetSetStr(){
	cout << "\n//HashSet with set<string>\n\n";
	HashSet<string,set<string> > con1;
	...
	colptr1->add("I");
	colptr1->add("J");
	HashSet<string,set<string> > con2;
